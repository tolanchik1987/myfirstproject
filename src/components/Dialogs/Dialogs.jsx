      ...
      <div className={classes.conteiner_dialogs}>
         ...
         <div className={classes.messages}>
            ...
            <div className={classes.addMessages}>
               <div>
                  <textarea onClick={clearMessage} className={classes.addMessage} ref={newMessageElement} cols="100" rows="10" value={messageText} onChange={e => setMessageText(e.target.value)}/>
               </div>
               <div>
                  <button className={classes.btnAddMessage} onClick={buttonAddMessage} type="button">Add</button>
               </div>
            </div>
         </div>
      </div>
